...
const data = [
    {
        id: 1,
        value: 'www.example.com/loremipsumdolor/sitmet',
        checked: false,
		change: 'down',
		instances: '4500',
...
function MostViolations(props) {
	...
	return (
		<CardWidget title="Pages with most violations">
...
export default React.memo(MostViolations);
